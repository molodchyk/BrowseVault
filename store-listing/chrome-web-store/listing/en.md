...
Use BrowseVault to search archived history by keyword, site, title, URL, exact day, date range, exclusion, phrase, or regex, with keyboard-first focus and debounced live refresh.

Scan results by local date with highlighted matches, then open, export, select, or delete the records you need.
...
Use Quick Open to search tabs, bookmarks, downloads, and recently closed pages from the same interface, then switch, open, or restore the result.

Control what gets saved with domain blacklist and whitelist rules, local display preferences, default result limits, and explicit destructive actions with undo where the vault can support it.
