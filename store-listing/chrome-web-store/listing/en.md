...
Scan results by local date with highlighted matches, use Load More or Show All when a search has many matches, then open, copy, export the current result set as JSON, CSV, or HTML, export selected records, select, or delete the vault records you need.
