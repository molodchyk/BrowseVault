...
Use BrowseVault to search archived history by keyword, site, host, domain, title, URL, source, transition, visit count, exact day, local hour, date range, exclusion, phrase, or regex, with saved searches, keyboard-first focus, and debounced live refresh.
