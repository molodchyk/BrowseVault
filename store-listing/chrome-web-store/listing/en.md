...
Export history in deterministic newest-first order as JSON, formula-safe spreadsheet CSV, or offline HTML reports with summary metrics, exact timestamps, in-file filtering, sortable columns, and safer link handling. Current-result exports follow the selected newest/oldest result order.
