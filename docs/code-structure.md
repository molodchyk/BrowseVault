...
- Move date formatting and preferences from `src/app.js` into a display/preferences feature.
- Move result rendering and selection state from `src/app.js` into a history-results feature.
