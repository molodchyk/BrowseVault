...
- JavaScript syntax, static import resolution, extension-page module script path, manifest and extension UI locale coverage, manifest path, privacy/permission disclosure parity, file-size budget, and folder-density checks pass;
- unit tests pass;
