...
Owns display settings, result-limit normalization, date formatting, count formatting, backup reminder cadence, backup status summaries, settings persistence orchestration, and extension-page preference/stat rendering.
