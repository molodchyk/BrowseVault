...
Owns extension-page actions for selected-record vault deletion, current-result vault deletion, Chrome-history deletion requests, undo, reset, domain archive/category rules, manual retention cleanup, and duplicate cleanup.
