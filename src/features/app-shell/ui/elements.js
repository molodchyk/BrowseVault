export function collectAppElements(document) {
  return {
    ...
    jumpResultsBottom: document.querySelector("#jump-results-bottom"),
    ...
    backupConfidence: document.querySelector("#backup-confidence"),
    ...
    archiveStorage: document.querySelector("#archive-storage"),
    archiveVault: document.querySelector("#archive-vault"),
    archiveTombstones: document.querySelector("#archive-tombstones"),
    archiveTopDomains: document.querySelector("#archive-top-domains"),
    archiveBusiestDay: document.querySelector("#archive-busiest-day"),
