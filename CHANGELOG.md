...
- Saved searches, match highlighting, local-date grouped results, incremental loading, one-click Show All expansion, keyboard-first search focus, and keyboard navigation for visible history rows.
